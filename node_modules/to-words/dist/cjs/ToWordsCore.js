...
exports.ToWordsCore = exports.DefaultToWordsOptions = exports.DefaultConverterOptions = void 0;
...
class ToWordsCore {
    ...
    convert(number, options = {}) {
        ...
        const mergedOptions = Object.keys(options).length === 0
            ? (baseOptions ?? {})
            : {
        ...
        const forceZeroFractional = !!mergedOptions.includeZeroFractional &&
            !isBigInt &&
    ...
    convertNumber(number, options = {}, localeOverride) {
        ...
        if (isFloat) {
            ...
            if (options.decimalStyle === 'fraction' && denominator) {
                ...
                const useSingular = localeConfig.fractionSingularRule === 'slavic'
    ...
    convertInternal(number, trailing = false, overrides = undefined, localeInstance, gender, useAnd) {
...
exports.ToWordsCore = ToWordsCore;
