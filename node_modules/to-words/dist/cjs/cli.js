...
const ToWords_js_1 = require("./ToWords.js");
function printHelp() {
...
if (args.includes('--detect-locale')) {
    console.log((0, ToWords_js_1.detectLocale)());
    process.exit(0);
}
...
if (localeIdx !== -1) {
    ...
    localeCode = (0, ToWords_js_1.detectLocale)();
}
try {
    const tw = new ToWords_js_1.ToWords({ localeCode });
    if (isOrdinal) {
