...
export function setLocaleDetector(fn) {
    _localeDetector = fn;
}
 ...
 */
export function detectLocale(fallback = DefaultToWordsOptions.localeCode) {
 ...
 */
export function toWords(number, options) {
 ...
 */
export function toOrdinal(number, options) {
